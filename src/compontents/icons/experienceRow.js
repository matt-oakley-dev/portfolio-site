...
export default function ExperienceRow({
    ...
    const content = {
		...
		'python': {
            'title': 'Python',
            'content': ' have gained valuable experience in writing API data syncs using Python programming language. I am proficient in using Python libraries and frameworks to interact with APIs, such as requests, urllib, and Flask. Additionally, I have experience in parsing JSON or XML data retrieved from APIs and manipulating it within my code to ensure real-time data synchronization with external APIs. My experience in this area enables me to develop software applications that require seamless data synchronization with external APIs.'
        },
        'wordpress': {
            'title': 'Wordpress',
